...
- Find/Replace `ui_extensions_flutter` to name of the flutter name of the app (ex: `my_spiffy_app`)
- Find/Replace `UI Extension Demp` to a label used to name the app on mobile Platforms (ex:`My Spiffy Mobile App`)
- Find/Replace `MAC UI Extension Demp` to the name of your macOS app (ex: `My Spiffy macOS App`)
...
- Find/Replace `ui_extensions_flutter` with bundle id (ex: `my_spiffy_app`) **[using the folder name is ideal]**
- Find/Replace `uiExtensionsFlutter` for Apple bundles as iOS/MacOS do like '_'. **[ideal is folder name to lower-camel case (ex: `mySpiffyApp`)]**
